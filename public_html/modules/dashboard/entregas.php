<?php 
	...
	//*INICIO CONSULTA SIC SOLO TOMA ENTREGADOS EXCLUYE RECHAZADOS//*
		  $db=Db::conectar();
          $select=$db->prepare("SELECT v.HoraEnt,v.FechaRS,v.CjasEntregadas,v.CjasEntregadasAcu,v.CjasProgramadas,IF(v.CjasEntregadasAcu=0,0,(v.CjasEntregadasAcu/v.CjasProgramadas)*100) as PorcentajeEntre FROM
				(
